...
def SumEven(No):
    print("PID of SumEven :",os.getpid())   # SumEven (51)
...
def SumOdd(No):
    print("PID of SumOdd :",os.getpid())    # SumOdd (101)
...
def main():
    ...
    print("PPID of main :",os.getppid())    # CMD eg(11)
    ...
    print("Time requered : ",end_time - start_time)
